...
public class DASRO {
	...
	public static String getToken(String userId, String ssoKey) {
//		ReturnObject returnJson = new ReturnObject();
		...
		try {
			String param = String.format("grant_type=password&client_id=%s&client_secret=%s&scope=/intuser&username=&password=&auth_type=DAS&user_id=%s&sso_key=%s&service_cd=A03", CLIENT_ID, CLIENT_SCERET, userId, ssoKey);
